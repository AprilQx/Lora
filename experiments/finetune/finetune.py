...
def main():
    ...
    # Basic parameters
    parser.add_argument("--train_file", type=str, default="../../data/processed2/train_texts.txt", required=True,help="Path to training data file")
    parser.add_argument("--val_file", type=str, default="../../data/processed2/val_texts.txt", required=True, help="Path to validation data file")
